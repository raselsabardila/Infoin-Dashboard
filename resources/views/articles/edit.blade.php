        ...
        <div class="card-body">
            <form action="{{ route("articles.update", $articleEdit) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <img src="{{ asset("storage/thumbnail/$articleEdit->thumbnail") }}" class="img-thumbnail mb-3" alt="" width="50%">
...
<script>
    CKEDITOR.replace( 'content',{
        filebrowserUploadUrl: "{{route('articles.image', ['_token' => csrf_token() ])}}",
