                                    ...
                                    <div class="col-md-12">
                                        <div class="row justify-content-center">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control @error("name") is-invalid @enderror" type="text" name="" wire:model="name">
                                                @error('name')
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="email" name="" readonly wire:model="email">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row justify-content-center">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control @error("phone") is-invalid @enderror" type="text" name="" wire:model="phone">
                                                @error('phone')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="" readonly value="{{ Auth::user()->role->name }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                @if (Auth::user()->verifications())
                                    ...
                                    <div>
                                        ...
                                        @if (Auth::user()->verifications()->status == 0)
                                            <span class="badge badge-pill badge-primary float-right">Menunggu</span>
                                        @endif
                                        @if (Auth::user()->verifications()->status == 1)
                                            <span class="badge badge-pill badge-primary float-right">Diijinkan</span>
                                        @endif
                                        @if (Auth::user()->verifications()->status == 2)
                                            <span class="badge badge-pill badge-primary float-right">Ditolak</span>
                                        @endif
                                    </div>
                                @else
